...
\begin{titlepage}
    ...
    {\Large Simulador del campo magnético alrededor de un conductor de forma arbitraria \par}
    \vspace{0.5cm}
...
\begin{equation} \label{eq:biot_savart}
    d\va{B} = \frac{\mu_0}{4 \pi} \frac{I d \va{l} \times \vu{r}}{\vb{r^2}}
\end{equation}
...
\begin{equation}
    \va{B} = \frac{\mu_0 I}{4 \pi} \int \frac{d \va{l} \times \vu{r}}{\vb{r^2}}
\end{equation}

\section{Implementación y limitaciones de la simulación}

\subsection{Stack tecnológico}
El simulador está desarrollado en TypeScript para la parte lógica, junto con HTML y CSS para la visualización, y Vite para el manejo y organización del proyecto. Puede ejecutarse localmente o probarse de manera online en cualquier dispositivo \\ (\url{https://jcdalbello.github.io/untref_fisica_2_tp_final_simulacion/}).

\subsection{Espacio de la simulación}
...
\subsection{Discretización y suma de Riemann}
...
\begin{equation}\label{eq:aproximacion_campo_magnetico}
    \va{B} \approx \frac{\mu_0 I}{4 \pi} \sum_{i=1}^{n} \frac{\Delta \va{l}_i \times \vu{r}_i}{\vb{r}^{2}_{i}}
\end{equation}

\subsection{Puntos de singularidad}
...
Se usó un valor arbitrario \verb|SINGULARITY_THRESHOLD = 0.05| que representa 0.05 \si{cm} en el espacio de la simulación, para representar el umbral luego del cual se produce el error en los cálculos.
...
El simulador puede probarse de manera online \\ \url{https://jcdalbello.github.io/untref_fisica_2_tp_final_simulacion/}.

Todo el material relacionado al proyecto, que incluye tanto el simulador como el presente documento y el código \LaTeX{} usado para generarlo, se encuentran disponibles en \url{https://github.com/jcdalbello/untref_fisica_2_tp_final_simulacion}.
